...
export const cartAggregateInclude = Prisma.validator<Prisma.CartInclude>()({
  customerProfile: {
    select: {
      id: true,
      userId: true,
...
export class CartAggregateSelectedOptionEntity {
...
export class CartAggregateItemEntity {
  cartItemId!: string;
  menuItemId!: string;
  branchId!: string;
...
export class CartAggregateEntity {
  cartId!: string | null;
...
export function buildCartAggregate(cart: CartAggregateRecord): CartAggregateEntity {
  return {
    cartId: cart.id,
...
export function buildEmptyCartAggregate(
  input: BuildEmptyCartAggregateInput,
): CartAggregateEntity {
  return {
    cartId: null,
