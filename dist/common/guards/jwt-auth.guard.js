...
let JwtAuthGuard = class JwtAuthGuard extends (0, passport_1.AuthGuard)('jwt') {
    ...
    async canActivate(context) {
        ...
        if ((0, rxjs_1.isObservable)(activationResult)) {
            return (0, rxjs_1.lastValueFrom)(activationResult);
        }
    ...
    handleRequest(error, user) {
        ...
        if (user === false || user === null || user === undefined) {
            throw new app_exception_1.AppException('Authentication required.', common_1.HttpStatus.UNAUTHORIZED, {
