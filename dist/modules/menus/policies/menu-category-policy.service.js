...
exports.MenuCategoryPolicyService = void 0;
const common_1 = require("@nestjs/common");
const menu_catalog_access_policy_helper_1 = require("./menu-catalog-access-policy.helper");
let MenuCategoryPolicyService = class MenuCategoryPolicyService {
    ...
    canManageCategory(currentUser, category) {
        return (0, menu_catalog_access_policy_helper_1.hasMerchantCatalogAccess)({
            currentUser,
...
exports.MenuCategoryPolicyService = MenuCategoryPolicyService;
exports.MenuCategoryPolicyService = MenuCategoryPolicyService = __decorate([
    (0, common_1.Injectable)()
], MenuCategoryPolicyService);
//# sourceMappingURL=menu-category-policy.service.js.map