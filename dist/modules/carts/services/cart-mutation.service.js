...
let CartMutationService = class CartMutationService {
    ...
    async addCurrentCustomerCartItem(currentUser, branchId, payload) {
        ...
        const selectedOptions = await this.resolveSelectedOptionsForMenuItem(menuItem.id, payload.selectedOptionIds ?? []);
    ...
    async resolveSelectedOptionsForMenuItem(menuItemId, selectedOptionIds) {
