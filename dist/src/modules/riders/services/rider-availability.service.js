...
let RiderAvailabilityService = class RiderAvailabilityService {
    constructor(riderAccountService, ridersRepository, queueService) {
    ...
    async markCurrentRiderOnline(currentUser) {
        ...
        await this.queueService.add(queue_constants_1.QueueNames.dispatch, queue_constants_1.QueueJobNames.dispatch.autoDispatchPendingForRider, { riderId: rider.id, township: rider.currentTownship ?? null }, { delayMs: 500 });
