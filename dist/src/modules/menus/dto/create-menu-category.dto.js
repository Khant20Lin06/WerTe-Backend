...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Optional approved branch store type identifiers that scope the category. Omit or pass an empty array to keep the category visible for all store types.',
...
], CreateMenuCategoryDto.prototype, "storeTypeIds", void 0);
