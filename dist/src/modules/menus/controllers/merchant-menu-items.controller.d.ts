...
export declare class MerchantMenuItemsController {
    ...
    listRuleProfiles(currentUser: AuthenticatedUserEntity, branchId: string): Promise<MenuItemRuleProfileDto[]>;
    ...
    delete(currentUser: AuthenticatedUserEntity, branchId: string, itemId: string): Promise<void>;
    adjustInventory(currentUser: AuthenticatedUserEntity, branchId: string, itemId: string, body: AdjustInventoryDto): Promise<MenuItemDto>;
}
