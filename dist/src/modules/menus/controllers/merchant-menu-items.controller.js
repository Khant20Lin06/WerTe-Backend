...
let MerchantMenuItemsController = class MerchantMenuItemsController {
    ...
    listRuleProfiles(currentUser, branchId) {
        return this.merchantMenuItemsService.listBranchItemRuleProfiles(currentUser, branchId);
    }
    ...
    delete(currentUser, branchId, itemId) {
        return this.merchantMenuItemsService.deleteBranchItem(currentUser, branchId, itemId);
    }
    adjustInventory(currentUser, branchId, itemId, body) {
        return this.merchantMenuItemsService.adjustBranchItemInventory(currentUser, branchId, itemId, body);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns the branch-effective store type catalog requirements that merchant menu items should satisfy.',
        type: menu_item_rule_profile_dto_1.MenuItemRuleProfileDto,
        isArray: true,
    }),
    (0, common_1.Get)('rule-profiles'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('branchId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [authenticated_user_entity_1.AuthenticatedUserEntity, String]),
    __metadata("design:returntype", void 0)
], MerchantMenuItemsController.prototype, "listRuleProfiles", null);
__decorate([
    (0, swagger_1.ApiOperation)({
...
__decorate([
    ...
    (0, swagger_1.ApiNoContentResponse)({ description: 'Menu item deleted.' }),
    ...
    __metadata("design:paramtypes", [authenticated_user_entity_1.AuthenticatedUserEntity, String, String]),
    __metadata("design:returntype", void 0)
], MerchantMenuItemsController.prototype, "delete", null);
__decorate([
    (0, swagger_1.ApiOperation)({
    ...
    (0, common_1.Post)(':itemId/inventory-adjustments'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('branchId')),
    __param(2, (0, common_1.Param)('itemId')),
    __param(3, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [authenticated_user_entity_1.AuthenticatedUserEntity, String, String, adjust_inventory_dto_1.AdjustInventoryDto]),
    __metadata("design:returntype", void 0)
], MerchantMenuItemsController.prototype, "adjustInventory", null);
