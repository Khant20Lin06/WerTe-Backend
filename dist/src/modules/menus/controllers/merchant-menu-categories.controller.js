...
let MerchantMenuCategoriesController = class MerchantMenuCategoriesController {
    ...
    delete(currentUser, branchId, categoryId) {
        return this.merchantMenuCategoriesService.deleteBranchCategory(currentUser, branchId, categoryId);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiNoContentResponse)({ description: 'Menu category deleted.' }),
    ...
    __metadata("design:paramtypes", [authenticated_user_entity_1.AuthenticatedUserEntity, String, String]),
    __metadata("design:returntype", void 0)
], MerchantMenuCategoriesController.prototype, "delete", null);
