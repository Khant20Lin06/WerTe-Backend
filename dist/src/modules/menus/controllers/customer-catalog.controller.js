...
const get_customer_branch_catalog_query_dto_1 = require("../dto/get-customer-branch-catalog-query.dto");
...
let CustomerCatalogController = class CustomerCatalogController {
    ...
    async getBranchMenu(branchId, query) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, get_customer_branch_catalog_query_dto_1.GetCustomerBranchCatalogQueryDto]),
