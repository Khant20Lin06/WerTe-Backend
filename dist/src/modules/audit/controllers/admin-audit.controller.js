...
let AdminAuditController = class AdminAuditController {
    ...
    listBranchMenuScopeLogs(currentUser, branchId, query) {
        return this.auditReadService.listAdminBranchMenuScopeAuditLogs(currentUser, branchId, query);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns menu category and menu item scope audit logs for the requested branch.',
        type: audit_log_entity_1.AuditLogEntity,
        isArray: true,
    }),
    (0, common_1.Get)('branches/:branchId/menu-scopes'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    ...
    __metadata("design:paramtypes", [authenticated_user_entity_1.AuthenticatedUserEntity, String, list_audit_logs_query_dto_1.ListAuditLogsQueryDto]),
    __metadata("design:returntype", void 0)
], AdminAuditController.prototype, "listBranchMenuScopeLogs", null);
