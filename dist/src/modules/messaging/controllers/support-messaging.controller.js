...
exports.SupportMessagingController = void 0;
...
let SupportMessagingController = class SupportMessagingController {
...
exports.SupportMessagingController = SupportMessagingController;
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'listCurrentSupportConversations',
        summary: 'List conversations visible to the authenticated support actor',
    }),
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns current support conversation summaries.',
...
], SupportMessagingController.prototype, "listConversations", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'listCurrentSupportOrderConversations',
        summary: 'List order conversations visible to the authenticated support actor',
    }),
    (0, swagger_1.ApiParam)({ name: 'orderId', example: 'order_1' }),
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns the current support conversation summaries for the order.',
        type: conversation_summary_entity_1.ConversationSummaryEntity,
        isArray: true,
    }),
    ...
    __metadata("design:returntype", void 0)
], SupportMessagingController.prototype, "listOrderConversations", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'resolveCurrentSupportConversation',
        summary: 'Resolve an order-scoped conversation for the authenticated support actor',
    }),
    (0, swagger_1.ApiParam)({ name: 'orderId', example: 'order_1' }),
    (0, swagger_1.ApiBody)({ type: resolve_conversation_dto_1.ResolveConversationDto }),
    (0, swagger_1.ApiCreatedResponse)({
        description: 'Resolves and syncs an order-scoped conversation lane for support.',
    ...
    __metadata("design:returntype", void 0)
], SupportMessagingController.prototype, "resolveConversation", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'getCurrentSupportConversation',
        summary: 'Get a support-visible conversation summary',
    }),
    (0, swagger_1.ApiParam)({ name: 'conversationId', example: 'con_1' }),
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns the requested support-visible conversation summary.',
        type: conversation_summary_entity_1.ConversationSummaryEntity,
    }),
    ...
    __metadata("design:returntype", void 0)
], SupportMessagingController.prototype, "getConversation", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'listCurrentSupportConversationMessages',
        summary: 'List messages visible to the authenticated support actor in a conversation',
    }),
    (0, swagger_1.ApiParam)({ name: 'conversationId', example: 'con_1' }),
    (0, swagger_1.ApiOkResponse)({
        description: 'Returns a paginated support-visible message list.',
    ...
    __metadata("design:returntype", void 0)
], SupportMessagingController.prototype, "listMessages", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'sendCurrentSupportConversationMessage',
        summary: 'Send a message from the authenticated support actor into a conversation',
    }),
    (0, swagger_1.ApiParam)({ name: 'conversationId', example: 'con_1' }),
    (0, swagger_1.ApiBody)({ type: send_conversation_message_dto_1.SendConversationMessageDto }),
    (0, swagger_1.ApiCreatedResponse)({
        description: 'Persists a new support message in the conversation.',
    ...
    __metadata("design:returntype", void 0)
], SupportMessagingController.prototype, "sendMessage", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        operationId: 'markCurrentSupportMessageRead',
        summary: 'Record a support read receipt for a message',
    }),
    (0, swagger_1.ApiParam)({ name: 'messageId', example: 'msg_1' }),
    (0, swagger_1.ApiOkResponse)({
        description: 'Records the support read position for the message conversation.',
...
], SupportMessagingController.prototype, "markRead", null);
exports.SupportMessagingController = SupportMessagingController = __decorate([
    (0, swagger_1.ApiTags)('support-messaging'),
...
//# sourceMappingURL=support-messaging.controller.js.map