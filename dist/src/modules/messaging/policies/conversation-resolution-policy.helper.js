...
function shouldAddOperationsParticipant(currentUser) {
    return isOperationsActor(currentUser) && !(0, system_authenticated_actor_helper_1.isSystemAuthenticatedActor)(currentUser);
}
