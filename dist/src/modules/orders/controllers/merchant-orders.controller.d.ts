...
export declare class MerchantOrdersController {
    ...
    list(currentUser: AuthenticatedUserEntity, branchId?: string): Promise<OrderSummaryDto[]>;
    ...
    markReady(currentUser: AuthenticatedUserEntity, orderId: string, body: MerchantOrderActionDto): Promise<OrderDetailDto>;
    confirmPickup(currentUser: AuthenticatedUserEntity, orderId: string, body: MerchantOrderActionDto): Promise<OrderDetailDto>;
}
