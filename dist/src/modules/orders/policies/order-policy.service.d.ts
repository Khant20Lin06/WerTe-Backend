...
export declare class OrderPolicyService {
    ...
    canMarkReady(currentUser: AuthenticatedUserEntity, order: OrderSummaryEntity): boolean;
    ...
    canMerchantConfirmPickup(currentUser: AuthenticatedUserEntity, order: OrderSummaryEntity): boolean;
}
