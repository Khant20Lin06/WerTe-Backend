...
let OrdersRepository = class OrdersRepository {
    ...
    findMerchantOrderSummaries(merchantId, options = {}, client = this.prisma) {
            ...
            data: {
                ...
                items: {
                    create: payload.cartItems.map((cartItem) => ({
                        ...
                        selectedVariantCombinationId: cartItem.selectedVariantCombinationId,
                        selectedVariantCombinationNameSnapshot: cartItem.selectedVariantCombinationNameSnapshot,
                        menuItemStockTrackedSnapshot: cartItem.menuItemStockTrackedSnapshot,
                        variantCombinationStockTrackedSnapshot: cartItem.variantCombinationStockTrackedSnapshot,
                        ...
                        inventoryLotAllocations: {
                            create: cartItem.inventoryLotAllocations.map((allocation) => ({
                                ...
                                expiryDateSnapshot: allocation.expiryDateSnapshot === null
                                    ? null
