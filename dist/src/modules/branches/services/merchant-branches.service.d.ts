...
export declare class MerchantBranchesService {
    ...
    constructor(prisma: PrismaService, merchantAccountService: MerchantAccountService, branchesRepository: BranchesRepository, branchesService: BranchesService, branchPolicyService: BranchPolicyService, zonesService: ZonesService);
