...
const admin_merchants_controller_1 = require("./controllers/admin-merchants.controller");
...
const merchant_cache_service_1 = require("./services/merchant-cache.service");
...
exports.MerchantsModule = MerchantsModule = __decorate([
    (0, common_1.Module)({
        controllers: [merchant_profile_controller_1.MerchantProfileController, admin_merchants_controller_1.AdminMerchantsController],
        providers: [
            ...
            admin_merchant_management_service_1.AdminMerchantManagementService,
        ],
